...
import { Card, CardContent } from "src/components/ui/card"; // Ensure the correct UI component import
...
export default function NotFound() {
  ...
  const handleGoHome = () => {
    router.push("/"); // Navigate to home page, the home page is in src/app/page.tsx
  };
